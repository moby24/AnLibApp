...
public class ArrAn {
	...
	static final String[] HISTORY_AN225 = {
			...
			"		Часто ошибочно указывают П. В. Балабуева главным конструктором. Балабуев являлся генеральным конструктором всего КБ в 1984—2005 годах. А главным конструктором — руководителем проекта — указом Совмина СССР был назначен В. И. Толмачев." };
	...
	static final String[] HISTORY_AN124 = {
			...
			"		Главным конструктором самолёта часто ошибочно указывают П. В. Балабуева. Балабуев в 1984—2005 годах являлся генеральным конструктором всего КБ. А главным конструктором — руководителем проекта по самолётам Ан-124 и Ан-225 — указом СОВМИНа СССР был назначен В. И. Толмачев.",
